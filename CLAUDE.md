...
- `Sources/EspansoUI/`
  ...
  - `Views/MatchListView.swift` — searchable list
...
- Image rendering: when a match's `replace` looks like a single `<img src="URL"/>`, the row shows an `AsyncImage`; otherwise it shows text
